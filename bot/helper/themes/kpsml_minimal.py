...
------------------------------------------\n\n"""
    ...
    L_CORRUPTED_FILES =     '<b>⚠️ Corrupted Files: </b>{Corrupt}\n'
    L_CC =                  '<b>👤 By: </b>{Tag}\n\n'
...
• <b>-s</b> or <b>-set</b>: Set Directly via Arg'''
    ...
    <b> ▶️ YT-DLP Options :</b> <b><code>{YT}</code></b>
    <b> 📅 Daily Tasks :</b> <code>{DT}</code> per day
    <b> ⏱️ Last Bot Used :</b> <code>{LAST_USED}</code>
    <b> 🔒 User Session :</b> <code>{USESS}</code>
    <b> ℹ️ MediaInfo Mode :</b> <code>{MEDIAINFO}</code>
    <b> 💾 Save Mode :</b> <code>{SAVE_MODE}</code>
    <b> 📨 User Bot PM :</b> <code>{BOT_PM}</code>'''

    MIRROR = '''㊂ <b><u>♻️ Mirror/Clone Settings : {NAME}</u></b>

    <b> 🔄 RClone Config :</b> <i>{RCLONE}</i>
    <b> 🏷️ Mirror Prefix :</b> <code>{MPREFIX}</code>
    <b> 🏷️ Mirror Suffix :</b> <code>{MSUFFIX}</code>
    ...
    <b> ⚖️ Equal Splits :</b> <i>{EQUAL_SPLIT}</i>
    <b> 🎬 Media Group :</b> <i>{MEDIA_GROUP}</i>
    <b> 📝 Leech Caption :</b> <code>{LCAPTION}</code>
    <b> 🏷️ Leech Prefix :</b> <code>{LPREFIX}</code>
    <b> 🏷️ Leech Suffix :</b> <code>{LSUFFIX}</code>
